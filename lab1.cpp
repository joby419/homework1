...
void render(Game *game)
{
   ...
   // ggprint16(&r, 16, 0x00ff0000, "Waterfall Model");
    ...
    if(i==1) {ggprint16(&r,16,cref,"requirements");}
    if(i==2) {ggprint16(&r,16,cref,"requirements");}
    if(i==3) {ggprint16(&r,16,cref,"requirements");}
    if(i==4) {ggprint16(&r,16,cref,"requirements");}
